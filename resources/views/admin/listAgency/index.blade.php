...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">{{ trans('contents.admin.agency') }}</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">{{ trans('contents.admin.home') }}</a></li>
                    <li class="breadcrumb-item active">{{ trans('contents.admin.agency') }}</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title col-md-8">{{ trans('contents.admin.list_agency') }}</h3>
                        <button type="button" class="btn btn-block btn-default col-md-2" style="float: right">{{ trans('contents.admin.add_agency') }}</button>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
